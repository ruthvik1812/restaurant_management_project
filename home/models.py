...
class Restaurant(models.Model):
    ...
    opening_hours = models.JSONField(
        ...
        help_text="Example: {'Mon-Fri': '10:00AM - 11:00PM', 'Sat-Sun': '9:00AM - 11:00PM'}"
    )
...
class TodaySpecial(models.Model):
    ...
    image = models.ImageField(upload_to="specials/", blank=True, null=True, verbose_name="Special Dish Image")
